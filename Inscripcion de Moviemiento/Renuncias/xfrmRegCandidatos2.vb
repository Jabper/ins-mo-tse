...
Public Class xfrmRegCandidatos2
    ...
    Sub Validarleyendas()
        ...
        'Me.IM_V_MOSTRAR_CANDIDATOS2TableAdapter.FillBY(Me.DSInsCandidatos.IM_V_MOSTRAR_CANDIDATOS2, id_movimiento, id_partido, muni, depto, CInt(Me.cboCargo.EditValue.ToString))
    ...
    Private Sub xfrmRegCandidatos2_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.GotFocus
        mostrarimg()
    End Sub
    Private Sub xfrmRegCandidatos2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    End Sub
    Private Sub xfrmRegCandidatos2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Try
    ...
    Sub guardar(ByVal I As Integer)
        ...
        Try
            ...
            Else
                ...
                Dim myCMD As New OracleCommand()
                myCMD.Connection = conn
                myCMD.CommandText = "IM_P_INSERT_CANDIDATOS2"
                myCMD.CommandType = CommandType.StoredProcedure
                'PNI_CODIGO_CANDIDATO
                myCMD.Parameters.Add(New OracleParameter("PNI_CODIGO_CANDIDATO", OracleType.Number, 2, ParameterDirection.Input)).Value = CodigoDelCandidato
                myCMD.Parameters.Add(New OracleParameter("PNI_POSICION", OracleType.Number, 2, ParameterDirection.Input)).Value = view.GetRowCellValue(I, "POSICION")
                ...
                If CType(myCMD.Parameters("PVO_MENSAJE").Value, String) = "OK" Then
                    ...
                    ActualizarEstadoCandidato(CodigoDelCandidato)
    ...
    Sub ValidarCandidatos(ByVal fila As Integer, ByVal requisito As Integer, ByVal iden As String, ByVal nombre1 As String, ByVal nombre2 As String, ByVal apellido1 As String, ByVal apellido2 As String)
        ...
        Try
            ...
            vcodigo_Candidato = CodigoDelCandidato
    ...
    Sub Establecer(ByVal iddepto As Integer, ByVal idmuni As Integer, ByVal idcargo As Integer, ByVal posicion As Integer)
        ...
        'Cargo Electivo
        'Dim c As Integer = Me.cboCargo.Properties.GetDataSourceRowIndex(Me.cboCargo.Properties.Columns("CODIGO_CARGO_ELECTIVO"), idcargo)
        'Me.cboCargo.EditValue = Me.cboCargo.Properties.GetDataSourceValue(Me.cboCargo.Properties.ValueMember, c)
        Me.cboCargo.EditValue = idcargo



        'Departamento
        'Dim d As Integer = Me.cboDepartamento.Properties.GetDataSourceRowIndex(Me.cboDepartamento.Properties.Columns("CODIGO_DEPARTAMENTO"), iddepto)
        'Me.cboDepartamento.EditValue = Me.cboDepartamento.Properties.GetDataSourceValue(Me.cboDepartamento.Properties.ValueMember, d)
        Me.cboDepartamento.EditValue = iddepto
        ...
        End Try
        'Municipio
        'Dim mn As Integer = Me.cboMunicipio.Properties.GetDataSourceRowIndex(Me.cboMunicipio.Properties.Columns("CODIGO_MUNICIPIO"), idmuni)
        'Me.cboMunicipio.EditValue = Me.cboMunicipio.Properties.GetDataSourceValue(Me.cboMunicipio.Properties.ValueMember, mn)
        Me.cboMunicipio.EditValue = idmuni
        Try
            Val_MUN_DEP()
            'Me.DSInsCandidatos.IM_V_MOSTRAR_CANDIDATOS2.Rows.Clear()
            Validarleyendas()
            ...
            Me.cboMunicipio.Enabled = False
            AgregarFilasGrid(1)
            GridView1.SetRowCellValue(0, "POSICION", posicion)
            GridView1.Columns("POSICION").OptionsColumn.AllowEdit = False

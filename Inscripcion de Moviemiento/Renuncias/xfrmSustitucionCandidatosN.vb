...
Public Class xfrmSustitucionCandidatosN
    ...
    Sub limpiarLabels()
        ...
        End If
    End Sub
    Private Sub xfrmSustitucionCandidatosN_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

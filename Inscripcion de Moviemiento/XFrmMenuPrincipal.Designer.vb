...
Partial Class XFrmMenuPrincipal
    ...
    Private Sub InitializeComponent()
        ...
        Me.BtnRFirmas.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.BtnFDP)})

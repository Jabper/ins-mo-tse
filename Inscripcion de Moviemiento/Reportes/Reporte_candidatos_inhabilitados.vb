...
Public Class Reporte_candidatos_inhabilitados
    ...
    Private Sub Reporte_candidatos_inhabilitados_ParametersRequestBeforeShow(ByVal sender As Object, ByVal e As DevExpress.XtraReports.Parameters.ParametersRequestEventArgs) Handles Me.ParametersRequestBeforeShow
        ...
        Using Adapter As New DS_REPORTE_CANDIDATOSTableAdapters.IM_MOVIMIENTOSTableAdapter
            'Adapter.Fill(dataset.IM_MOVIMIENTOS)
            '-------------------------------------------------------------
            ...
            If ActivarOpciones.PEstado = "PDO" Or ActivarOpciones.PEstado = "MOV" Or ActivarOpciones.PEstado = "TSE" Then
                ...
                Adapter.FillCodPartido(dataset.IM_MOVIMIENTOS, CType(idp, Integer))
                'Else
    ...
    Private Sub Reporte_candidatos_inhabilitados_ParametersRequestValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraReports.Parameters.ParametersRequestValueChangedEventArgs) Handles Me.ParametersRequestValueChanged

...
Public Class REPORTE_DE_CUMPLIMIENTO_2

    Private Sub REPORTE_DE_CUMPLIMIENTO_2_ParametersRequestBeforeShow(ByVal sender As Object, ByVal e As DevExpress.XtraReports.Parameters.ParametersRequestEventArgs) Handles Me.ParametersRequestBeforeShow
    ...
    Private Sub REPORTE_DE_CUMPLIMIENTO_2_ParametersRequestSubmit(ByVal sender As Object, ByVal e As DevExpress.XtraReports.Parameters.ParametersRequestEventArgs) Handles Me.ParametersRequestSubmit
        ...
        Prese_6.Text = (CInt(muni_completo) + CInt(muni_incompleto)).ToString 'Fisico_6.Text
        ...
        CD_5.Text = (CInt(congresos_completo) + CInt(congresos_incompleto)).ToString
        Fisico_5.Text = (CInt(congresos_completo) + CInt(congresos_incompleto)).ToString
        Prese_5.Text = (CInt(congresos_completo) + CInt(congresos_incompleto)).ToString
        Coin_5.Text = (CInt(congresos_completo) + CInt(congresos_incompleto)).ToString


        Prese_4.Text = (CInt(congresop_completo) + CInt(incon_congrep)).ToString
    ...
    Private Sub REPORTE_DE_CUMPLIMIENTO_2_ParametersRequestValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraReports.Parameters.ParametersRequestValueChangedEventArgs) Handles Me.ParametersRequestValueChanged

...
Namespace DS_REPORTE_DE_DP_1TableAdapters
    ...
    Partial Public Class IM_MOVIMIENTOSTableAdapter
        ...
        Public Overloads Overridable Function FillCod_Partido(ByVal dataTable As DS_REPORTE_DE_DP_1.IM_MOVIMIENTOSDataTable, ByVal ID_PARTIDO As Decimal) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal ID_PARTIDO As Decimal) As DS_REPORTE_DE_DP_1.IM_MOVIMIENTOSDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(ID_PARTIDO,Decimal)
            Dim dataTable As DS_REPORTE_DE_DP_1.IM_MOVIMIENTOSDataTable = New DS_REPORTE_DE_DP_1.IM_MOVIMIENTOSDataTable
            Me.Adapter.Fill(dataTable)

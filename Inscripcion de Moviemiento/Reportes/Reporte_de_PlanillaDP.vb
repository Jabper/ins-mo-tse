...
Public Class Reporte_de_PlanillaDP
    ...
    Private Sub Reporte_de_PlanillaDP_ParametersRequestValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraReports.Parameters.ParametersRequestValueChangedEventArgs) Handles Me.ParametersRequestValueChanged

...
Partial Public Class DS_REPORTE_CANDIDATOS
    ...
    Private Sub InitClass()
        ...
        Me.relationIM_FK1_MOVIMIENTOS = New Global.System.Data.DataRelation("IM_FK1_MOVIMIENTOS", New Global.System.Data.DataColumn() {Me.tableIM_PP_CANDIDATOS.CODIGO_PARTIDOColumn}, New Global.System.Data.DataColumn() {Me.tableIM_MOVIMIENTOS.CODIGO_PARTIDOColumn}, false)
    ...
    Partial Public Class IM_V_MOSTRAR_CANDIDATOS2DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddIM_V_MOSTRAR_CANDIDATOS2Row(ByVal IMAGEN() As Byte, ByVal CONSTANCIA() As Byte, ByVal IDENTIDAD As String, ByVal POSICION As Decimal, ByVal PARTIDO As String, ByVal DEPARTAMENTO As String, ByVal NOMBRE As String, ByVal APELLIDO As String, ByVal NOMBRE_MOVIMIENTO As String, ByVal NIVEL As String, ByVal NIVELELECTIVO As String, ByVal CARGO As String) As IM_V_MOSTRAR_CANDIDATOS2Row
            Dim rowIM_V_MOSTRAR_CANDIDATOS2Row As IM_V_MOSTRAR_CANDIDATOS2Row = CType(Me.NewRow,IM_V_MOSTRAR_CANDIDATOS2Row)
            Dim columnValuesArray() As Object = New Object() {IMAGEN, CONSTANCIA, IDENTIDAD, POSICION, PARTIDO, DEPARTAMENTO, NOMBRE, APELLIDO, NOMBRE_MOVIMIENTO, NIVEL, NIVELELECTIVO, CARGO}
    ...
    Partial Public Class IM_MOVIMIENTOSDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddIM_MOVIMIENTOSRow(ByVal CODIGO_MOVIMIENTO As Decimal, ByVal NOMBRE_MOVIMIENTO As String, ByVal IMAGEN() As Byte, ByVal parentIM_PP_CANDIDATOSRowByIM_FK1_MOVIMIENTOS As IM_PP_CANDIDATOSRow) As IM_MOVIMIENTOSRow
            ...
            If (Not (parentIM_PP_CANDIDATOSRowByIM_FK1_MOVIMIENTOS) Is Nothing) Then
                columnValuesArray(3) = parentIM_PP_CANDIDATOSRowByIM_FK1_MOVIMIENTOS(0)
            End If
    ...
    Partial Public Class IM_V_MOSTRAR_CANDIDATOS2Row
        ...
        Public Property NIVEL() As String
            Get
                Return CType(Me(Me.tableIM_V_MOSTRAR_CANDIDATOS2.NIVELColumn),String)
            End Get
            Set
                Me(Me.tableIM_V_MOSTRAR_CANDIDATOS2.NIVELColumn) = value
            End Set
        End Property
        ...
        Public Property NIVELELECTIVO() As String
            Get
                Try 
                    Return CType(Me(Me.tableIM_V_MOSTRAR_CANDIDATOS2.NIVELELECTIVOColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'NIVELELECTIVO' in table 'IM_V_MOSTRAR_CANDIDATOS2' is DBNul"& _ 
                            "l.", e)
                End Try
            End Get
            Set
                Me(Me.tableIM_V_MOSTRAR_CANDIDATOS2.NIVELELECTIVOColumn) = value
            End Set
        End Property
        ...
        Public Function IsNIVELELECTIVONull() As Boolean
            Return Me.IsNull(Me.tableIM_V_MOSTRAR_CANDIDATOS2.NIVELELECTIVOColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetNIVELELECTIVONull()
            Me(Me.tableIM_V_MOSTRAR_CANDIDATOS2.NIVELELECTIVOColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class IM_MOVIMIENTOSRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Property IM_PP_CANDIDATOSRow() As IM_PP_CANDIDATOSRow
            Get
                Return CType(Me.GetParentRow(Me.Table.ParentRelations("IM_FK1_MOVIMIENTOS")),IM_PP_CANDIDATOSRow)
            End Get
            Set
...
Namespace DS_REPORTE_CANDIDATOSTableAdapters
    ...
    Partial Public Class IM_V_MOSTRAR_CANDIDATOS2TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        a.IMAGEN, a.CONSTANCIA, a.IDENTIDAD, a.NOMBRE, a.APELLIDO, a.POSICI"& _ 
                "ON, a.PARTIDO, a.DEPARTAMENTO, a.""NIVELELECTIVO"", CA.DESCRIPCION ""CARGO"","&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"     "& _ 
                "                    M.NOMBRE_MOVIMIENTO AS ""NOMBRE MOVIMIENTO"", N.DESCRIPCION AS"& _ 
                " NIVEL"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            IM_V_PLANILLA_CANDIDATOS a, IM_CANDIDATOS c, IM_MOVIMIEN"& _ 
                "TOS m, IM_NIVEL_ELECTIVO n, IM_CARGOS_ELECTIVOS ca, IM_PARTIDOS_Politicos pa"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WH"& _ 
                "ERE  (A.IDENTIDAD = C.IDENTIDAD) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND (C.ESTADO = 'H') "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND (C.CODIGO_PARTIDO "& _ 
                "= PA.CODIGO_PARTIDO )"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND (C.CODIGO_PARTIDO = M.CODIGO_PARTIDO) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND (A.CODIGO"& _ 
                "MOVIMIENTO = C.CODIGO_MOVIMIENTO )"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND (C.CODIGO_MOVIMIENTO = M.CODIGO_MOVIMIEN"& _ 
                "TO)  "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND (C.CODIGO_CARGO_ELECTIVO = CA.CODIGO_CARGO_ELECTIVO) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND (CA.CODIGO"& _ 
                "_NIVEL_ELECTIVO = N.CODIGO_NIVEL_ELECTIVO) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY a.POSICION"
    ...
    Partial Public Class IM_MOVIMIENTOSTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT        CODIGO_MOVIMIENTO, NOMBRE_MOVIMIENTO AS ""NOMBRE MOVIMIENTO"", INSIGN"& _ 
                "IA AS IMAGEN, CODIGO_PARTIDO"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            IM_MOVIMIENTOS"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (CODI"& _ 
                "GO_PARTIDO = :id_partido)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY CODIGO_MOVIMIENTO"
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As DS_REPORTE_CANDIDATOS.IM_MOVIMIENTOSDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As DS_REPORTE_CANDIDATOS.IM_MOVIMIENTOSDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DS_REPORTE_CANDIDATOS.IM_MOVIMIENTOSDataTable = New DS_REPORTE_CANDIDATOS.IM_MOVIMIENTOSDataTable
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        Public Overloads Overridable Function FillCodPartido(ByVal dataTable As DS_REPORTE_CANDIDATOS.IM_MOVIMIENTOSDataTable, ByVal id_partido As Decimal) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal id_partido As Decimal) As DS_REPORTE_CANDIDATOS.IM_MOVIMIENTOSDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(id_partido,Decimal)
            Dim dataTable As DS_REPORTE_CANDIDATOS.IM_MOVIMIENTOSDataTable = New DS_REPORTE_CANDIDATOS.IM_MOVIMIENTOSDataTable
            Me.Adapter.Fill(dataTable)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DS_REPORTE_CANDIDATOS.IM_MOVIMIENTOSDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function

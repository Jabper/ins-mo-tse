...
Public Class REPORTE_CIU_INCONSISTENTE
    ...
    Private Sub REPORTE_CIU_INCONSISTENTE_ParametersRequestBeforeShow(ByVal sender As Object, ByVal e As DevExpress.XtraReports.Parameters.ParametersRequestEventArgs) Handles Me.ParametersRequestBeforeShow

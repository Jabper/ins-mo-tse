            ...
            Using conexion As New OleDbConnection(connString)
                ...
                For Each row As System.Data.DataRow In dt.Rows
                    Try
                        ...
                        & "', '" & row.Item(8).ToString & "', '" & row.Item(9).ToString & "', '" & row.Item(10).ToString & "', to_date('" & row.Item(11).ToString & "','dd/mm/yyyy hh:mi:ss p.m.')" _
                        & ", null, null, '" & row.Item(12).ToString & "')"
            ...
            Using conexion As New OleDbConnection(connString)
                ...
                For Each row As System.Data.DataRow In dt.Rows
                    Try
                        ...
                        & row.Item(0).ToString & "', '" & row.Item(1).ToString & "', '" & row.Item(2).ToString & "', '" & row.Item(3).ToString _
                        & "', to_date('" & row.Item(4).ToString & "','dd/mm/yyyy hh:mi:ss p.m.'), null, null, '" & row.Item(5).ToString & "')"
                        myCMD.CommandType = CommandType.Text
                        myCMD.ExecuteOracleScalar()
                    Catch ex As Exception
                        conn.Close()
            ...
            Using conexion As New OleDbConnection(connString)
                ...
                For Each row As System.Data.DataRow In dt.Rows
                    Try
                        ...
                        & "', '" & row.Item(4).ToString & "', null, '" & row.Item(5).ToString & "', to_date('" & row.Item(6).ToString & "','dd/mm/yyyy hh:mi:ss p.m.'), null, null, '" & row.Item(7).ToString & "')"
                        myCMD.CommandType = CommandType.Text                        
                        myCMD.ExecuteOracleScalar()
                    Catch ex As Exception
                        conn.Close()

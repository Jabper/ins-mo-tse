...
Namespace DTUsersTableAdapters
    ...
    Partial Public Class IM_OPCIONESTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.OracleClient.OracleCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT ADICIONADO_POR, CODIGO_OPCION, DESCRIPCION, FECHA_ADICION, FECHA_MODIFICAC"& _ 
                "ION, MODIFICADO_POR, NOMBRE_CONTROL FROM IM_OPCIONES WHERE (CODIGO_OPCION = :id)"& _ 
                ""
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text

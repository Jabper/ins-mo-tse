...
Partial Public Class DTUsers
    ...
    Partial Public Class DT_USUARIOSDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddDT_USUARIOSRow(ByVal CODIGO_USUARIO As String, ByVal NOMBRE As String, ByVal ESTADO As String, ByVal DESCRIPCION As String, ByVal NOMBRE_MOVIMIENTO As String, ByVal PARTIDO As String) As DT_USUARIOSRow
            Dim rowDT_USUARIOSRow As DT_USUARIOSRow = CType(Me.NewRow,DT_USUARIOSRow)
            Dim columnValuesArray() As Object = New Object() {CODIGO_USUARIO, NOMBRE, ESTADO, DESCRIPCION, NOMBRE_MOVIMIENTO, PARTIDO}
...
Namespace DTUsersTableAdapters
    ...
    Partial Public Class DT_USUARIOSTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.OracleClient.OracleCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        IM_USUARIOS.CODIGO_USUARIO, IM_USUARIOS.NOMBRE, IM_USUARIOS.ESTADO,"& _ 
                " IM_ROLES.DESCRIPCION, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         IM_PARTIDOS_POLITICOS.NOMBRE A"& _ 
                "S PARTIDO, IM_MOVIMIENTOS.NOMBRE_MOVIMIENTO"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            IM_USUARIOS, IM_ROL"& _ 
                "ES, IM_MOVIMIENTOS, IM_PARTIDOS_POLITICOS"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        IM_USUARIOS.CODIGO_ROL ="& _ 
                " IM_ROLES.CODIGO_ROL AND IM_USUARIOS.CODIGO_USUARIO = IM_ROLES.ADICIONADO_POR AN"& _ 
                "D "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         IM_USUARIOS.CODIGO_USUARIO = IM_MOVIMIENTOS.ADICION"& _ 
                "ADO_POR AND "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         IM_USUARIOS.CODIGO_PARTIDO = IM_PARTIDOS_"& _ 
                "POLITICOS.CODIGO_PARTIDO AND "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         IM_USUARIOS.CODIGO_USUAR"& _ 
                "IO = IM_PARTIDOS_POLITICOS.ADICIONADO_POR AND "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         IM_MOVI"& _ 
                "MIENTOS.CODIGO_PARTIDO = IM_PARTIDOS_POLITICOS.CODIGO_PARTIDO"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub

            ...
            If Trim(mensaje) = "OK" Then
                ...
                If Trim(mensaje) = "OK" Then
                    Try
                        ...
                        Dim startInfo As ProcessStartInfo
                        Dim pStart As New Process
                        startInfo = New ProcessStartInfo("cmd.exe", "/C impdp TSE/ORACLE@XE DUMPFILE=" & archivo & " LOGFILE=imp_Respaldo.log DIRECTORY=DATA_PUMP_DIR CONTENT=ALL TABLE_EXISTS_ACTION=REPLACE")
                        'imp TSE/TSEORACLE2012@XE Buffer=5000000 File=" & TxtRuta.Text & " FROMUSER=TSE TOUSER=TSE ignore=Y")
                        pStart.StartInfo = startInfo
                        pStart.Start()
                        pStart.WaitForExit()

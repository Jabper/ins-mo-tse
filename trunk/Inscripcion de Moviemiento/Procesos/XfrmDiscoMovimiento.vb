    ...
    Private Sub BtnEjecutar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnEjecutar.Click
        If Not (TxtRuta.Text = Nothing) Then
            If Not (LovPartido.EditValue Is Nothing) Then
                If Not (LovMovimiento.EditValue Is Nothing) Then
                    ...
                    Dim sql As String = "select codigo_partido, codigo_movimiento from im_parametros_generales"
                    ...
                    If chek.Read Then
                        ...
                        Else
                            partido = "Null"
                        End If
                        If Not IsDBNull(chek.Item("codigo_movimiento")) Then
                            movimiento = chek.Item("codigo_movimiento")
                        Else
                            movimiento = "null"
                        End If
                    End If
                    ...
                    Try
                        ...
                        myCMD.CommandText = "Update im_parametros_generales set codigo_partido = " & LovPartido.EditValue & ", codigo_movimiento = " & LovMovimiento.EditValue
                    ...
                    If My.Computer.FileSystem.DirectoryExists(Application.StartupPath.ToString & "\CSIM") Then
                        ...
                        If comprobararchivos() Then
                            ...
                            Try
                                ...
                                myCMD1.CommandText = "Update im_parametros_generales set codigo_partido = " & partido & ", codigo_movimiento = " & movimiento
                        ...
                        End If
                    Else
                        MsgBox("Error no se encontraron los archivos...")
                        Dim oradb3 As String = Configuracion.verconfig
                        Dim conn3 As New OracleConnection()
                        Dim myCMD3 As New OracleCommand()
                        conn3.ConnectionString = oradb3
                    ...
                    End If
                Else
                    MsgBox("Debe seleccionar un movimiento.")
                End If
            Else

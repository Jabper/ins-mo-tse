        ...
        Else
            ...
            If proceso_corriendo = "N" Then
                ...
                Try
                    ...
                    startInfo = New ProcessStartInfo("cmd.exe", "/C impdp TSE/ORACLE@XE directory=data_pump_dir dumpfile=" & archivo & " LOGFILE=imp_firmas_y_planilla.log TABLE_EXISTS_ACTION=REPLACE")

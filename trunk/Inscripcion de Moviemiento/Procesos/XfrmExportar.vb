        ...
        Else
            ...
            If Trim(mensaje) = "OK" Then
                ...
                Try
                    ...
                    startInfo = New ProcessStartInfo("cmd.exe", "/C expdp TSE/ORACLE@XE directory=data_pump_dir dumpfile=Firmas_y_Planilla.dmp LOGFILE=firmas_y_planilla.log TABLES=('TMP_IM_CANDIDATOS', 'TMP_IM_CIUDADANOS_RESPALDAN', 'TMP_IM_IMAGENES_FIRMAS', 'TMP_IM_MOVIMIENTOS', 'TMP_IM_PARAMETROS_GENERALES', 'TMP_IM_REQUISITOS_X_CANDIDATO')")

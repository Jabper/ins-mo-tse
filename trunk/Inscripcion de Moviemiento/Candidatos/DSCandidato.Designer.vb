...
Partial Public Class DSCandidato
    ...
    Partial Public Class DT_CANDIDATODataTable
        ...
        Public Overloads Function AddDT_CANDIDATORow( _
            ...
            Dim columnValuesArray() As Object = New Object() {CODIGO_CANDIDATOS, NOMBRE, POSICION, CODIGO_CARGO_ELECTIVO, APELLIDO, CODIGO_DEPARTAMENTO, CODIGO_MUNICIPIO, CODIGO_MOVIMIENTO, IDENTIDAD, CODIGO_PARTIDO, FECHA_MODIFICACION, NOMBRE_MOVIMIENTO, PARTIDOPOLITICO, CARGOELECTIVO, DEPARTAMENTO, MUNICIPIO}
    ...
    Partial Public Class DT_CANDIDATORow
        ...
        Public Property CODIGO_DEPARTAMENTO() As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableDT_CANDIDATO.CODIGO_DEPARTAMENTOColumn),Decimal)
                Catch e As Global.System.InvalidCastException
        ...
        Public Property CODIGO_MUNICIPIO() As Decimal
            Get
                Return CType(Me(Me.tableDT_CANDIDATO.CODIGO_MUNICIPIOColumn),Decimal)
            End Get
            Set

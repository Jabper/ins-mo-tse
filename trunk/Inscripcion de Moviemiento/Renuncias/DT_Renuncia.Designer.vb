...
Partial Public Class DT_Renuncia
    ...
    Partial Public Class IM_V_CANDIDATO_RENUNCIADataTable
        ...
        Public Overloads Function AddIM_V_CANDIDATO_RENUNCIARow( _
                    ...
                    ByVal CODIGO_CARGO_ELECTIVO As Decimal) As IM_V_CANDIDATO_RENUNCIARow
            Dim rowIM_V_CANDIDATO_RENUNCIARow As IM_V_CANDIDATO_RENUNCIARow = CType(Me.NewRow,IM_V_CANDIDATO_RENUNCIARow)
            Dim columnValuesArray() As Object = New Object() {CODIGO_CANDIDATOS, IDENTIDAD, NOMBRE, APELLIDO, POSICION, CARGO, CODIGO_DEPARTAMENTO, DEPARTAMENTO, CODIGO_MUNICIPIO, MUNICIPIO, CODIGO_PARTIDO, PARTIDO, CODIGO_MOVIMIENTO, NOMBRE_MOVIMIENTO, MOTIVO, RENUNCIA, CODIGO_CARGO_ELECTIVO}
    ...
    Partial Public Class IM_RENUNCIASDataTable
        ...
        Public Overloads Function AddIM_RENUNCIASRow( _
                    ...
                    ByVal parentIM_MOTIVOS_RENUNCIARowByIM_FK1_RENUNCIAS As IM_MOTIVOS_RENUNCIARow) As IM_RENUNCIASRow
            Dim rowIM_RENUNCIASRow As IM_RENUNCIASRow = CType(Me.NewRow,IM_RENUNCIASRow)
            Dim columnValuesArray() As Object = New Object() {CODIGO_CANDIDATO, POSICION, CODIGO_CARGO_ELECTIVO, CODIGO_DEPARTAMENTO, CODIGO_MUNICIPIO, CODIGO_MOVIMIENTO, IDENTIDAD, CODIGO_PARTIDO, ADICIONADO_POR, FECHA_ADICION, MODIFICADO_POR, FECHA_MODIFICACION, PRIMER_NOMBRE, SEGUNDO_NOMBRE, PRIMER_APELLIDO, SEGUNDO_APELLIDO, Nothing}
    ...
    Partial Public Class IM_V_CANDIDATO_RENUNCIATableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        CODIGO_CANDIDATOS, IDENTIDAD, NOMBRE, APELLIDO, POSICION, CARGO, CO"& _ 
                "DIGO_DEPARTAMENTO, DEPARTAMENTO, CODIGO_MUNICIPIO, MUNICIPIO, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                "& _ 
                "         CODIGO_PARTIDO, PARTIDO, CODIGO_MOVIMIENTO, NOMBRE_MOVIMIENTO, MOTIVO, "& _ 
    ...
    Partial Public Class IM_RENUNCIASTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""IM_RENUNCIAS"" (""CODIGO_CANDIDATO"", ""POSICION"", ""CODIGO_CARGO_ELECTIV"& _ 
                ...
                "LLIDO"", ""CODIGO_MOTIVO"") VALUES (:CODIGO_CANDIDATO, :POSICION, :CODIGO_CARGO_ELE"& _ 
                "CTIVO, :CODIGO_DEPARTAMENTO, :CODIGO_MUNICIPIO, :CODIGO_MOVIMIENTO, :IDENTIDAD, "& _ 
                ":CODIGO_PARTIDO, :ADICIONADO_POR, :FECHA_ADICION, :MODIFICADO_POR, :FECHA_MODIFI"& _ 
                "CACION, :PRIMER_NOMBRE, :SEGUNDO_NOMBRE, :PRIMER_APELLIDO, :SEGUNDO_APELLIDO, :C"& _ 
                "ODIGO_MOTIVO)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE ""IM_RENUNCIAS"" SET ""CODIGO_CANDIDATO"" = :CODIGO_CANDIDATO, ""POSICION"" = :P"& _ 
                ...
                "O"" = :CODIGO_MOTIVO WHERE ((""CODIGO_CANDIDATO"" = :Original_CODIGO_CANDIDATO) AND"& _ 
                " ((:IsNull_POSICION = 1 AND ""POSICION"" IS NULL) OR (""POSICION"" = :Original_POSIC"& _ 
                "ION)) AND (""CODIGO_CARGO_ELECTIVO"" = :Original_CODIGO_CARGO_ELECTIVO) AND (""CODI"& _ 
                "GO_DEPARTAMENTO"" = :Original_CODIGO_DEPARTAMENTO) AND (""CODIGO_MUNICIPIO"" = :Ori"& _ 
                ...
                "Original_FECHA_MODIFICACION)) AND ((:IsNull_PRIMER_NOMBRE = 1 AND ""PRIMER_NOMBRE"& _ 
                """ IS NULL) OR (""PRIMER_NOMBRE"" = :Original_PRIMER_NOMBRE)) AND ((:IsNull_SEGUNDO"& _ 
                "_NOMBRE = 1 AND ""SEGUNDO_NOMBRE"" IS NULL) OR (""SEGUNDO_NOMBRE"" = :Original_SEGUN"& _ 
                "DO_NOMBRE)) AND ((:IsNull_PRIMER_APELLIDO = 1 AND ""PRIMER_APELLIDO"" IS NULL) OR "& _ 
                "(""PRIMER_APELLIDO"" = :Original_PRIMER_APELLIDO)) AND ((:IsNull_SEGUNDO_APELLIDO "& _ 
                "= 1 AND ""SEGUNDO_APELLIDO"" IS NULL) OR (""SEGUNDO_APELLIDO"" = :Original_SEGUNDO_A"& _ 
                "PELLIDO)) AND ((:IsNull_CODIGO_MOTIVO = 1 AND ""CODIGO_MOTIVO"" IS NULL) OR (""CODI"& _ 
                "GO_MOTIVO"" = :Original_CODIGO_MOTIVO)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        CODIGO_CANDIDATO, POSICION, CODIGO_CARGO_ELECTIVO, CODIGO_DEPARTAME"& _ 
                ...
                "N, PRIMER_NOMBRE, SEGUNDO_NOMBRE, PRIMER_APELLIDO, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         SE"& _ 
                "GUNDO_APELLIDO, CODIGO_MOTIVO"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            IM_RENUNCIAS"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        Public Overloads Overridable Function Insert( _
                    ...
                    ByVal PRIMER_APELLIDO As String,  _
                    ByVal SEGUNDO_APELLIDO As String,  _
                    ByVal CODIGO_MOTIVO As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Update( _
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(17).Value = CType(Original_CODIGO_CANDIDATO,Decimal)
            If (Original_POSICION.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(18).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(19).Value = CType(Original_POSICION.Value,Decimal)
            Else
                Me.Adapter.UpdateCommand.Parameters(18).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(19).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(20).Value = CType(Original_CODIGO_CARGO_ELECTIVO,Decimal)
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(33).Value = CType(Original_PRIMER_NOMBRE,String)
            End If
            If (Original_SEGUNDO_NOMBRE Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(35).Value = CType(Original_SEGUNDO_NOMBRE,String)
            End If
            If (Original_PRIMER_APELLIDO Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(37).Value = CType(Original_PRIMER_APELLIDO,String)
            End If
            If (Original_SEGUNDO_APELLIDO Is Nothing) Then
            ...
            If (Original_CODIGO_MOTIVO.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(41).Value = CType(Original_CODIGO_MOTIVO.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_SEGUNDO_APELLIDO As String,  _
                    ByVal Original_CODIGO_MOTIVO As Global.System.Nullable(Of Decimal)) As Integer
            Return Me.Update(Original_CODIGO_CANDIDATO, POSICION, CODIGO_CARGO_ELECTIVO, CODIGO_DEPARTAMENTO, CODIGO_MUNICIPIO, Original_CODIGO_MOVIMIENTO, IDENTIDAD, Original_CODIGO_PARTIDO, ADICIONADO_POR, FECHA_ADICION, MODIFICADO_POR, FECHA_MODIFICACION, PRIMER_NOMBRE, SEGUNDO_NOMBRE, PRIMER_APELLIDO, SEGUNDO_APELLIDO, CODIGO_MOTIVO, Original_CODIGO_CANDIDATO, Original_POSICION, Original_CODIGO_CARGO_ELECTIVO, Original_CODIGO_DEPARTAMENTO, Original_CODIGO_MUNICIPIO, Original_CODIGO_MOVIMIENTO, Original_IDENTIDAD, Original_CODIGO_PARTIDO, Original_ADICIONADO_POR, Original_FECHA_ADICION, Original_MODIFICADO_POR, Original_FECHA_MODIFICACION, Original_PRIMER_NOMBRE, Original_SEGUNDO_NOMBRE, Original_PRIMER_APELLIDO, Original_SEGUNDO_APELLIDO, Original_CODIGO_MOTIVO)
        End Function
    End Class

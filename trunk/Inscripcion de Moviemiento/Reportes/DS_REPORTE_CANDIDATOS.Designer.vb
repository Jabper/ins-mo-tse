...
Partial Public Class DS_REPORTE_CANDIDATOS
    ...
    Partial Public Class IM_V_MOSTRAR_CANDIDATOS2DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddIM_V_MOSTRAR_CANDIDATOS2Row(ByVal IMAGEN() As Byte, ByVal CONSTANCIA() As Byte, ByVal IDENTIDAD As String, ByVal POSICION As Decimal, ByVal PARTIDO As String, ByVal DEPARTAMENTO As String, ByVal NIVEL_ELECTIVO As String, ByVal NOMBRE As String, ByVal APELLIDO As String, ByVal NOMBRE_MOVIMIENTO As String, ByVal NIVEL As String) As IM_V_MOSTRAR_CANDIDATOS2Row
            Dim rowIM_V_MOSTRAR_CANDIDATOS2Row As IM_V_MOSTRAR_CANDIDATOS2Row = CType(Me.NewRow,IM_V_MOSTRAR_CANDIDATOS2Row)
            Dim columnValuesArray() As Object = New Object() {IMAGEN, CONSTANCIA, IDENTIDAD, POSICION, PARTIDO, DEPARTAMENTO, NIVEL_ELECTIVO, NOMBRE, APELLIDO, NOMBRE_MOVIMIENTO, NIVEL}
    ...
    Partial Public Class IM_V_MOSTRAR_CANDIDATOS2TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        a.IMAGEN, a.CONSTANCIA, a.IDENTIDAD, a.NOMBRE, a.APELLIDO, a.POSICI"& _ 
                "ON, a.PARTIDO, a.DEPARTAMENTO, ""NIVEL ELECTIVO"", M.NOMBRE_MOVIMIENTO ""NOMBRE MOV"& _ 
                "IMIENTO"", N.DESCRIPCION ""NIVEL"""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            IM_V_PLANILLA_CANDIDATOS a, im_"& _ 
                "candidatos c, im_movimientos m, im_nivel_electivo n, im_cargos_electivos ca"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"whe"& _ 
                "re A.IDENTIDAD = C.IDENTIDAD"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"and C.ESTADO ='H'"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"and C.CODIGO_PARTIDO = M.CODIGO"& _ 
                "_PARTIDO"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"and C.CODIGO_MOVIMIENTO = M.CODIGO_MOVIMIENTO"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"and C.CODIGO_CARGO_ELEC"& _ 
                "TIVO = CA.CODIGO_CARGO_ELECTIVO "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"and CA.CODIGO_NIVEL_ELECTIVO = N.CODIGO_NIVEL_"& _ 
                "ELECTIVO "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"order by posicion "

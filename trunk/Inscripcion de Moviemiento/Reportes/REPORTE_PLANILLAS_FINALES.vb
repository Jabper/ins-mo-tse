...
Public Class REPORTE_PLANILLAS_FINALES
    ...
    Sub llenarDataSet(ByVal municipio As String, ByVal partido As String, ByVal departamento As String, ByVal cargo As String, ByVal movimiento As String)

        IM_CANDIDATOSTableAdapter.FillBy(DS_PLANILLA_TOTALES1.IM_CANDIDATOS, municipio, partido, movimiento, departamento, cargo)

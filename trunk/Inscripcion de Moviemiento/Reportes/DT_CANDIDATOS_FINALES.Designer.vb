...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("DT_CANDIDATOS_FINALES"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class DT_CANDIDATOS_FINALES
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As DT_CANDIDATOS_FINALES = CType(MyBase.Clone,DT_CANDIDATOS_FINALES)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "DT_CANDIDATOS_FINALES"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/DT_CANDIDATOS_FINALES.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As DT_CANDIDATOS_FINALES = New DT_CANDIDATOS_FINALES
    ...
    Partial Public Class IM_V_MOSTRAR_CANDIDATOS2DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddIM_V_MOSTRAR_CANDIDATOS2Row(ByVal PARTIDO As String, ByVal POSICION As Decimal, ByVal CARGO As String, ByVal NOMBRE As String, ByVal APELLIDO As String, ByVal DEPARTAMENTO As String, ByVal MUNICIPIO As String, ByVal IMAGEN() As Byte, ByVal CODIGO_CANDIDATOS As Decimal, ByVal MOVIMIENTO As String) As IM_V_MOSTRAR_CANDIDATOS2Row
            Dim rowIM_V_MOSTRAR_CANDIDATOS2Row As IM_V_MOSTRAR_CANDIDATOS2Row = CType(Me.NewRow,IM_V_MOSTRAR_CANDIDATOS2Row)
            Dim columnValuesArray() As Object = New Object() {PARTIDO, POSICION, CARGO, NOMBRE, APELLIDO, DEPARTAMENTO, MUNICIPIO, IMAGEN, CODIGO_CANDIDATOS, MOVIMIENTO}
    ...
    Partial Public Class IM_V_MOSTRAR_CANDIDATOS2Row
        ...
        Public Property MOVIMIENTO() As String
            Get
                Return CType(Me(Me.tableIM_V_MOSTRAR_CANDIDATOS2.MOVIMIENTOColumn),String)
            End Get
            Set
                Me(Me.tableIM_V_MOSTRAR_CANDIDATOS2.MOVIMIENTOColumn) = value
            End Set
        End Property
...
Namespace DT_CANDIDATOS_FINALESTableAdapters
    ...
    Partial Public Class IM_V_MOSTRAR_CANDIDATOS2TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = " select can.codigo_candidatos, can.nombre,can.apellido, can.posicion,CE.DESCRIPCI"& _ 
                "ON AS CARGO,PP.NOMBRE AS PARTIDO,MOV.NOMBRE_MOVIMIENTO AS MOVIMIENTO,"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&" DEP.DESC"& _ 
                "RIPCION AS DEPARTAMENTO, MUN.DESCRIPCION AS MUNICIPIO,rc.imagen"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&" from im_cand"& _ 
                "idatos  can"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&" join im_cargos_electivos  ce on CAN.CODIGO_CARGO_ELECTIVO=CE.CODIG"& _ 
                "O_CARGO_ELECTIVO"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&" join im_partidos_politicos  pp on CAN.CODIGO_PARTIDO=PP.CODIG"& _ 
                "O_PARTIDO"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&" join IM_MOVIMIENTOS  MOV ON CAN.CODIGO_MOVIMIENTO=MOV.CODIGO_MOVIMIE"& _ 
                "NTO"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&" JOIN IM_DEPARTAMENTOS DEP ON CAN.CODIGO_DEPARTAMENTO=DEP.CODIGO_DEPARTAMEN"& _ 
                "TO"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&" JOIN IM_MUNICIPIOS MUN ON (CAN.CODIGO_MUNICIPIO=MUN.CODIGO_MUNICIPIO ) AND("& _ 
                " MUN.CODIGO_DEPARTAMENTO=DEP.CODIGO_DEPARTAMENTO)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&" join im_requisitos_x_candida"& _ 
                "to rc on (can.codigo_partido=rc.codigo_partido) and (can.codigo_movimiento=rc.co"& _ 
                "digo_movimiento) and (CAN.CODIGO_CANDIDATOS=rc.codigo_candidato) and  rc.CODIGO_"& _ 
                "REQUISITO=7"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DT_CANDIDATOS_FINALES.IM_V_MOSTRAR_CANDIDATOS2DataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DT_CANDIDATOS_FINALES.IM_V_MOSTRAR_CANDIDATOS2DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DT_CANDIDATOS_FINALES.IM_V_MOSTRAR_CANDIDATOS2DataTable = New DT_CANDIDATOS_FINALES.IM_V_MOSTRAR_CANDIDATOS2DataTable
    ...
    Partial Public Class TableAdapterManager
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As DT_CANDIDATOS_FINALES, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Function UpdateInsertedRows(ByVal dataSet As DT_CANDIDATOS_FINALES, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            Return result
        End Function
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Function UpdateDeletedRows(ByVal dataSet As DT_CANDIDATOS_FINALES, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            Return result
        End Function
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overridable Function UpdateAll(ByVal dataSet As DT_CANDIDATOS_FINALES) As Integer
